...
public class School {
    ...
    public List<SchoolMenu> getMonthlyMenu(int year, int month) throws SchoolException {
        ...
        StringBuilder targetUrl = new StringBuilder("https://" + schoolRegion.url + "/" + MONTHLY_MENU_URL);
        targetUrl.append("?");
        ...
        targetUrl.append("schYm=").append(year).append(String.format(Locale.KOREA, "%02d", month)).append("&");
    ...
    public List<SchoolSchedule> getMonthlySchedule(int year, int month) throws SchoolException {
        ...
        StringBuilder targetUrl = new StringBuilder("https://" + schoolRegion.url + "/" + SCHEDULE_URL);
        targetUrl.append("?");
        targetUrl.append("schulCode=").append(schoolCode).append("&");
        targetUrl.append("schulCrseScCode=").append(schoolType.id).append("&");
        targetUrl.append("schulKndScCode=" + "0").append(schoolType.id).append("&");
        targetUrl.append("ay=").append(year).append("&");
        targetUrl.append("mm=").append(String.format(Locale.KOREA, "%02d", month)).append("&");
